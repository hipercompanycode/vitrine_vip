  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <span className="absolute right-3 top-3 rounded-pill bg-black/55 px-2 py-0.5 text-[11px] font-medium text-white backdrop-blur-sm">
          {timeAgo(new Date(ad.created_at), now)}
        </span>
        {typeof ad.like_count === "number" && ad.like_count > 0 && (
          <span className="absolute bottom-3 left-3 inline-flex items-center gap-1 rounded-pill bg-black/55 px-2 py-0.5 text-[11px] font-medium text-white backdrop-blur-sm">
