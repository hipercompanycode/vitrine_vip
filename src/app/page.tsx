    ...
    <>
      ...
      <main className="mx-auto w-full max-w-[1600px] flex-1 px-3 pb-16 sm:px-4">
        <section className="py-4">
          ...
          <Link href="/acompanhantes" className="mt-1.5 inline-flex items-center gap-1 text-sm font-semibold text-accent transition-opacity hover:opacity-80">
            Ver acompanhantes por cidade
