...
export default function PrivacidadePage() {
  return (
    <main className="mx-auto w-full max-w-2xl flex-1 px-4 py-10">
      ...
      <P>Não vendemos seus dados. Compartilhamos apenas com prestadores necessários para operar o serviço — hospedagem e banco de dados (Supabase) e o processador de pagamentos (Asaas, para cobranças via <strong className="text-ink">Pix</strong>) — e com autoridades quando exigido por lei. O WhatsApp informado no anúncio é público por sua escolha, para contato dos interessados.</P>
