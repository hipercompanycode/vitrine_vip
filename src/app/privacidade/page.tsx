...
export default function PrivacidadePage() {
  return (
    <main className="mx-auto w-full max-w-2xl flex-1 px-4 py-10">
      ...
      <P>
        <strong className="text-ink">Cadastro:</strong> e-mail e senha. <strong className="text-ink">Anúncio:</strong> nome de exibição, WhatsApp, idade, cidade, descrição, fotos e preços. <strong className="text-ink">Verificação:</strong> documento com foto e fotos de rosto/corpo — arquivos <strong className="text-ink">privados</strong>. <strong className="text-ink">Uso:</strong> cidade aproximada (quando você permite), favoritos, curtidas e denúncias.
      </P>
      ...
      <P>Não vendemos seus dados. Compartilhamos apenas com prestadores necessários para operar o serviço — hospedagem e banco de dados (Supabase) e processadores de pagamento (cartão e Pix) — e com autoridades quando exigido por lei. O WhatsApp informado no anúncio é público por sua escolha, para contato dos interessados.</P>

      <H>6. Cookies</H>
      <P>Usamos cookies essenciais: confirmação de maioridade (age_ok), sessão de login e preferências de localização. Não usamos cookies para publicidade de terceiros.</P>
